...
let CryptoJS = (typeof globalThis !== "undefined" && globalThis.CryptoJS) ? globalThis.CryptoJS : null;
try { if (!CryptoJS && typeof require === "function") CryptoJS = require("crypto-js"); } catch (_) { CryptoJS = null; }
...
function generateSignedUrl(url) {
    if (!CryptoJS || !CryptoJS.HmacSHA256) return null;
